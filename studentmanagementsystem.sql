...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 06, 2022 at 05:06 PM
...
INSERT INTO `contact` (`enroll`, `subject`, `message`) VALUES
('20103231', 'Hi', 'Yash');
...
('20103216', 't1', 17, 17, 20, 19, 17),
('20103216', 't2', 17, 14, 18, 13, 15),
('20103216', 't3', 52, 49, 42, 51, 45),
...
CREATE TABLE `exam_sem2` (
  `enroll` varchar(15) DEFAULT NULL,
  `exam_id` varchar(2) DEFAULT NULL,
...
('20103216', 't1', 17, 19, 17, 18, 0),
('20103216', 't2', 16, 17, 15, 17, 15),
('20103216', 't3', 50, 46, 55, 57, 57),
...
('T1001', 'Dr. Himanshu Pandey', 'T1001'),
('T1002', 'Dr. Rahul Singh', 'T1002'),
('T1003', 'Dr. Shreya Garg', 'T1003');
...
--
-- Indexes for table `stu_result`
--
ALTER TABLE `stu_result`
  ADD PRIMARY KEY (`enroll`);
COMMIT;
